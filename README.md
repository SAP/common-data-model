...
The CDM is an evolving model. The first version of the schema is version 3.2. The version of the schema determines which business content can be included in it.
